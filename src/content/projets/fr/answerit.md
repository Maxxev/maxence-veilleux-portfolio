...
ordre: 50
vedette: false
technos: ['Python', 'Flask', 'SQLite', 'JavaScript', 'HTML', 'CSS']
faits:
...
couverture:
  ...
  position: '50% 20%'
videos:
  - src: '/medias/videos/answerit.mp4'
    poster: '/medias/videos/answerit.webp'
    titre: "Parcours de l'interface d'AnswerIt"
youtube:
  - id: 'jVTknpZXtY0'
    titre: 'CS50x 2023 Final Project: AnswerIt Website'
liens:
  - type: 'video'
    url: 'https://www.youtube.com/watch?v=jVTknpZXtY0'
    libelle: 'Présentation du projet'
mention: null
---

AnswerIt est un médium social simple : on publie, on répond, on interagit avec
les publications des autres. C'était mon projet final pour **CS50x**, le cours
