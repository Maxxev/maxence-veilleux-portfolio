...
faits:
  ...
  - "Une section d'aperçu et sa page complète sont toujours alimentées par la même source et le même composant de grille, pour qu'elles ne puissent pas diverger avec le temps."
...
C'est une contrainte qu'on s'impose au départ et qui rapporte à chaque
modification ultérieure. Le client peut toucher au contenu sans risquer de
casser la mise en page, et moi je n'ai pas à relire chaque changement.
...
Ce portfolio est construit sur exactement ce socle. Le mode sombre que tu peux
basculer en haut de cette page n'a demandé aucune règle spécifique dans les
composants : il n'a fallu que redéfinir une couche de jetons sémantiques.
